...
# Generar la lista de puertos a escanear (solo el puerto ingresado)
common_ports = [port_to_scan]
...
def scan_ip(ip):
    # Ajustar para escanear solo el puerto ingresado
    scan_port(ip, port_to_scan)
...
def write_results():
    ...
    with open(filename, "w") as file:
        ...
        file.write(f"Puerto escaneado: {port_to_scan}\n")
