...
payload_structure = {'/': {'post': {'parameters': [{'name': 'idempotency-id', 'schema': {'in': 'header', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'otp', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'purposeCode', 'schema': {'$ref_name': 'PurposeCode'}}, {'name': 'requestedExecutionDate', 'schema': {'$ref_name': 'RequestedExecutionDate'}}, {'name': 'debtor', 'schema': {'$ref_name': 'Debtor'}}, {'name': 'debtorAccount', 'schema': {'$ref_name': 'DebtorAccount'}}, {'name': 'paymentIdentification', 'schema': {'$ref_name': 'PaymentIdentification'}}, {'name': 'instructedAmount', 'schema': {'$ref_name': 'InstructedAmount'}}, {'name': 'creditorAgent', 'schema': {'$ref_name': 'CreditorAgent'}}, {'name': 'creditor', 'schema': {'$ref_name': 'Creditor'}}, {'name': 'creditorAccount', 'schema': {'$ref_name': 'CreditorAccount'}}, {'name': 'remittanceInformationStructured', 'schema': {'$ref_name': 'RemittanceInformationStructured'}}, {'name': 'remittanceInformationUnstructured', 'schema': {'$ref_name': 'RemittanceInformationUnstructured'}}]}}, '/{paymentId}/status': {'get': {'parameters': [{'name': 'paymentId', 'schema': {'in': 'path', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}]}}, '/{paymentId}': {'get': {'parameters': [{'name': 'paymentId', 'schema': {'in': 'path', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}]}, 'delete': {'parameters': [{'name': 'paymentId', 'schema': {'in': 'path', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'idempotency-id', 'schema': {'in': 'header', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'otp', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}]}, 'patch': {'parameters': [{'name': 'paymentId', 'schema': {'in': 'path', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'idempotency-id', 'schema': {'in': 'header', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'otp', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'action', 'schema': {'$ref_name': 'Action'}}, {'name': 'authId', 'schema': {'$ref_name': 'AuthId'}}]}}, '/bulk': {'post': {'parameters': [{'name': 'idempotency-id', 'schema': {'in': 'header', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'otp', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'groupHeader', 'schema': {'$ref_name': 'GroupHeader'}}, {'name': 'paymentInformation', 'schema': {'type': 'array', 'items': {'$ref': '#/components/schemas/PaymentInformation'}}}]}}, '/bulk/{paymentId}/status': {'get': {'parameters': [{'name': 'paymentId', 'schema': {'in': 'path', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}]}}, '/bulk/{paymentId}': {'get': {'parameters': [{'name': 'paymentId', 'schema': {'in': 'path', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}]}, 'delete': {'parameters': [{'name': 'paymentId', 'schema': {'in': 'path', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'idempotency-id', 'schema': {'in': 'header', 'type': 'string', 'format': 'uuid', 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'otp', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': None, 'minLength': None, 'enum': None, '$ref_name': None}}, {'name': 'Correlation-Id', 'schema': {'in': 'header', 'type': 'string', 'format': None, 'maxLength': 50, 'minLength': None, 'enum': None, '$ref_name': None}}]}}}
