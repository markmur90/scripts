...
def main():
    ...
    json_path = script_dir
    json_file = "fields_configuration.json"
    zip_dir = script_dir
    zip_files = ["gpt3.zip", "gpt4.zip"]
    omit_files = []
    omit_validators = []
        ...
        try:
            with zipfile.ZipFile(zip_path_full, 'r') as z:
                ...
                for entry in json_entries:
                    ...
                    matching = set(schema_lower_set) & set(json_lower_map.keys())
                    missing = set(schema_lower_set) - matching
                    ...
                    print(f"    Campos esperados encontrados: {len(matching)} de {len(schema_lower_set)}")
                    print("    Validaciones:")
