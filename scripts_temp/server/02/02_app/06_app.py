...
<link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/css/bootstrap.min.css" rel="stylesheet">
  ...
  <div class="d-flex justify-content-between mb-4">
    <div>
      ...
      <a href="{{ url_for('list_reports') }}" class="btn btn-secondary">Ver reportes</a>
    </div>
      ...
      {% for r in reports %}
        <li class="list-group-item d-flex justify-content-between align-items-center">
          ...
          <div>
            ...
            <a href="{{ url_for('download_report', name=r) }}" class="btn btn-sm btn-success">Descargar</a>
          </div>
        </li>
      {% endfor %}
      </ul>
...
def login():
    ...
    if form.validate_on_submit():
        if (form.username.data == 'APP_USER' and
            form.password.data == 'APP_PASS'):
            session['logged'] = True
