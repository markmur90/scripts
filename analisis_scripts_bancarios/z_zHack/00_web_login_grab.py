...
# === URLs ===
LOGIN_WEB = "https://ebanking.db.com"  # Web interna donde se carga el login
TOKEN_ENDPOINT = "https://ebanking.db.com/api/login/"  # Endpoint de login de API
...
session.headers.update({
    ...
    "X-Origin-IP": "80.78.30.242",
    "X-Forwarded-For": "80.78.30.242",
    "X-Location": "coretransapi1",
