...
from utils import generate_end_to_end_identification, correlation_id, check_required_headers, generate_uuid
...
def enviar_transaccion(ip: str, usuario: str, clave: str, estado: str, paymentId: str) -> None:
    from data import API_URL, DATA  # Mover la importación aquí
